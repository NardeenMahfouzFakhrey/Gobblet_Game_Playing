...
//
//    /**
//     * method returns color of winner by checking if passed parameter completes the board,
//     * in case both players won, it returns opposite color of passed one
//     *
//     * @param gobbletColor
//     * @return GobbletColor
//     */
...
//
//
//    GobbletColor isWinningState(GobbletColor gobbletColor){
//
//        int myScore;
//
//        for(int i = 0; i < 4; i++) {
